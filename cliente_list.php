...
/**
 *   	\file       cliente_list.php
 *		\ingroup    carteiracliente
 *		\brief      List page for cliente
 */
...
require_once __DIR__.'/class/cliente.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('carteiracliente', 'cliente', 'write');
	$permissiontodelete = $user->hasRight('carteiracliente', 'cliente', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("Clientes");
//$help_url = "EN:Module_Cliente|FR:Module_Cliente_FR|ES:Módulo_Cliente";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/carteiracliente/cliente_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/carteiracliente/cliente_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendClienteRef";
$modelmail = "cliente";
$objecttmp = new Cliente($db);
